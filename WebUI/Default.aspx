		...
		<ContentTemplate>
			...
			<section class="pt-3">		
				<div class="row">
					<%-- ORDINANCES --%>
					<div class="col-md-6">
						<a href="./Ordinances" class="btn btn-secondary btn-home-link w-100" tabindex="-1" data-disable-btn="aspIconBtn" data-disable-btn-symbol="true">
					...
					<%-- NEW FACT SHEET --%>
					<div class="col-md-6">
						<a href="./NewFactSheet" class="btn btn-secondary btn-home-link w-100" tabindex="-1" data-disable-btn="aspIconBtn" data-disable-btn-symbol="true">
							<span class="fa-kit fa-solid-file-lines-circle-plus home-link-icon"></span>
							<div class="home-link-text-div">
